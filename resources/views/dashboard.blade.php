           ...
           <div class="kt-menu-item" data-kt-menu-item-offset="0, 0" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="hover">
            <button class="kt-menu-toggle kt-btn kt-btn-outline flex-nowrap">
             ...
             <span class="hidden md:inline text-nowrap">
              {{ $currentCarbonDate->format('F, Y') }}
             </span>
             <span class="inline md:hidden text-nowrap">
              {{ $currentCarbonDate->format('M, Y') }}
             </span>
              ...
              <div class="kt-card-content p-5">
                <div class="flex flex-col sm:flex-row items-center gap-3">
                  <div class="grow w-full sm:w-auto">
                    ...
                    <div class="kt-menu kt-menu-default w-full" data-kt-menu="true">
                        <div class="kt-menu-item w-full" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click" data-kt-menu-item-placement="bottom-start">
                            <button type="button" class="kt-menu-toggle kt-btn kt-btn-outline justify-between w-full">
                                <span class="kt-menu-title">Please select Activation Code type</span>
                                <span class="kt-menu-arrow">
                                    <i class="ki-filled ki-down"></i>
                                </span>
                            </button>
                            <div class="kt-menu-dropdown p-0 w-full max-w-lg">
                                <div class="kt-menu-item">
                                    <a href="#" class="kt-menu-link">
                                        <span class="kt-menu-title">30-day license code 7.50 HOTCOIN</span>
                                    </a>
                                </div>
                                <div class="kt-menu-item">
                                    <a href="#" class="kt-menu-link">
                                        <span class="kt-menu-title">90-day license code 15.00 HOTCOIN</span>
                                    </a>
                                </div>
                                <div class="kt-menu-item">
                                    <a href="#" class="kt-menu-link">
                                        <span class="kt-menu-title">180-day license code 30.00 HOTCOIN</span>
                                    </a>
                                </div>
                                <div class="kt-menu-item">
                                    <a href="#" class="kt-menu-link">
                                        <span class="kt-menu-title">365-day license code 60.00 HOTCOIN</span>
                                    </a>
                                </div>
                                <div class="kt-menu-item">
                                    <a href="#" class="kt-menu-link">
                                        <span class="kt-menu-title">1-day license code 1.00 HOTCOIN</span>
                                    </a>
                                </div>
                                <div class="kt-menu-item">
                                    <a href="#" class="kt-menu-link">
                                        <span class="kt-menu-title">7-day license code 3.00 HOTCOIN</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                  ...
                  <button class="kt-btn kt-btn-primary w-full sm:w-auto whitespace-nowrap">
              ...
              <div class="kt-card">
                <div class="kt-card-content p-5">
                  <div class="flex items-center gap-3">
                    ...
                    <div class="grow">
                      <div class="text-2xl font-semibold text-purple-400">{{ number_format($hotcoinBalance, 2) }}</div>
          ...
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             ...
             <span class="text-2sm font-normal text-muted-foreground">
              john.doe@gmail.com connections
             </span>
            </div>
           </div>
           <div class="flex items-center gap-2.5">
