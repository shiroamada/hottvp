...
'<button id="bEdit" type="button" class="btn btn-sm btn-info" onclick="rowEdit(this);">' +
...
'<span class="glyphicon glyphicon-ok" >affirm</span>'+
'</button>'+
...
// '</button>'+
  ...
  $.fn.SetEditable = function (options) {
    var defaults = {
        ...
        box: null,        //Jquery object of "Add" button
