...
let components = {
	nprogress: {
		selector: 'html',
		styles: '/public/components/nprogress/nprogress.css',
		script: '/public/components/nprogress/nprogress.js',
		init: function () {
			NProgress.configure({
	...
	sessionTimeout: {
		...
		styles: [
			'/public/components/modal/modal.css',
			'/public/components/animate/animate.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/bootstrap/js/popper.js',
			'/public/components/bootstrap/js/bootstrap.min.js',
			'/public/components/session-timeout/session-timeout.js'
		],
		init: function () {
			let
	...
	highlight: {
		selector: '.highlight',
		styles: '/public/components/highlight/highlight.css',
		script: '/public/components/highlight/highlight.pack.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	dualListBox: {
		...
		styles: [
			'/public/components/button/button.css',
			'/public/components/input/input.css',
			'/public/components/mdi/mdi.css',
			'/public/components/dual-listbox/dual-listbox.css'
		],
		script: '/public/components/dual-listbox/dual-listbox.min.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	breadcrumbs: {
		selector: '.breadcrumb',
		styles: '/public/components/breadcrumbs/breadcrumbs.css'
	},
	badge: {
		selector: '.badge',
		styles: '/public/components/badge/badge.css'
	},
	code: {
		selector: 'code',
		styles: '/public/components/code/code.css'
	},
	dropCap: {
		selector: '.drop-cap',
		styles: '/public/components/drop-cap/drop-cap.css'
	},
	media: {
		selector: '.media',
		styles: '/public/components/media/media.css'
	},
	card: {
		selector: '.card',
		styles: '/public/components/card/card.css'
	},
	panel: {
		selector: '.panel',
		styles: '/public/components/panel/panel.css'
	},
	adminPanel: {
		selector: '.panel.admin-panel',
		styles: [
			'/public/components/font-awesome/font-awesome.css',
			'/public/components/admin-panel/admin-panel.css'
		],
		script: [
			'/public/components/admin-panel/class-switch.js',
			'/public/components/admin-panel/admin-panel.js',
			'/public/components/multiswitch/multiswitch.js',
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	divider: {
		selector: '.divider',
		styles: '/public/components/divider/divider.css'
	},
	blockquote: {
		selector: '.blockquote',
		styles: '/public/components/blockquote/blockquote.css'
	},
	section: {
		selector: 'section',
		styles: '/public/components/section/section.css'
	},
	alert: {
		selector: '.alert',
		styles: '/public/components/alert/alert.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/bootstrap/js/popper.js',
			'/public/components/bootstrap/js/bootstrap.min.js'
	...
	alertToggle: {
		...
		script: '/public/components/base/jquery-3.4.1.min.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	dropdown: {
		...
		styles: '/public/components/dropdown/dropdown.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/bootstrap/js/popper.js',
			'/public/components/bootstrap/js/bootstrap.min.js'
	...
	invoice: {
		...
		styles: '/public/components/invoice/invoice.css'
	},
	button: {
		selector: '.btn',
		styles: '/public/components/button/button.css'
	},
	table: {
		selector: '.table',
		styles: '/public/components/table/table.css'
	},
	list: {
		selector: '[class*="list"]',
		styles: '/public/components/list/list.css'
	},
	progress: {
		selector: '.progress',
		styles: '/public/components/progress/progress.css'
	},
	nav: {
		selector: '.nav',
		styles: '/public/components/nav/nav.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/bootstrap/js/popper.js',
			'/public/components/bootstrap/js/bootstrap.min.js'
	...
	input: {
		...
		styles: '/public/components/input/input.css'
	},
	maxlength: {
		selector: '[maxlength]',
		styles: [
			'/public/components/badge/badge.css',
			'/public/components/maxlength/maxlength.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/maxlength/bootstrap-maxlength.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).maxlength({
	...
	typeahead: {
		...
		styles: '/public/components/typeahead/typeahead.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/typeahead/typeahead.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	select2: {
		selector: '.select2',
		styles: '/public/components/select2/select2.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
	...
	fontAwesome: {
		selector: '[class*="fa-"]',
		styles: '/public/components/font-awesome/font-awesome.css'
	},
	mdi: {
		selector: '[class*="mdi-"]',
		styles: '/public/components/mdi/mdi.css'
	},
	linearicons: {
		selector: '[class*="linearicons-"]',
		styles: '/public/components/linearicons/linearicons.css'
	},
	fontMuli : {
		selector: 'html',
	...
	spinner: {
		...
		styles: '/public/components/spinner/spinner.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/base/jquery-ui.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).spinner({
	...
	timeSpinner: {
		...
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/base/jquery-ui.min.js',
			'/public/components/base/globalize.min.js'
		],
	...
	daterangepiker: {
		...
		styles: [
			'/public/components/button/button.css',
			'/public/components/daterangepicker/daterangepicker.css'
		],
		script: [
			'/public/components/base/moment.min.js',
			'/public/components/daterangepicker/daterangepicker.min.js'
		],
	...
	datetimepicker: {
		...
		styles: [
			'/public/components/button/button.css',
			'/public/components/dropdown/dropdown.css',
			'/public/components/datetimepicker/bootstrap-datetimepicker.css'
		],
		script: [
			'/public/components/base/moment.min.js',
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/datetimepicker/bootstrap-datetimepicker.min.js'
		],
		dependencies: 'currentDevice',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	tagManager: {
		...
		styles: [
			'/public/components/badge/badge.css',
			'/public/components/tag-manager/tag-manager.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/tag-manager/tag-manager.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	tooltip: {
		...
		styles: '/public/components/tooltip/tooltip.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/bootstrap/js/popper.js',
			'/public/components/bootstrap/js/bootstrap.min.js'
	...
	popover: {
		...
		styles: '/public/components/popover/popover.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/bootstrap/js/popper.js',
			'/public/components/bootstrap/js/bootstrap.min.js'
	...
	colorpicker: {
		...
		styles: [
			'/public/components/popover/popover.css',
			'/public/components/colorpicker/colorpicker.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/bootstrap/js/popper.js',
			'/public/components/bootstrap/js/bootstrap.min.js',
			'/public/components/colorpicker/colorpicker.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).colorpicker({
	...
	maskedinput: {
		...
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/maskedinput/jquery.maskedinput.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	ckeditor: {
		...
		styles: '/public/components/ckeditor/ckeditor.css',
		script: '/public/components/ckeditor/ckeditor.min.js',
		init: function ( nodes ) {
			let promises = [];
	...
	close: {
		selector: '.close',
		styles: '/public/components/close/close.css'
	},
	summernote: {
		selector: '.summernote',
		styles: [
			'/public/components/button/button.css',
			'/public/components/input/input.css',
			'/public/components/table/table.css',
			'/public/components/close/close.css',
			'/public/components/dropdown/dropdown.css',
			'/public/components/tooltip/tooltip.css',
			'/public/components/popover/popover.css',
			'/public/components/modal/modal.css',
			'/public/components/card/card.css',
		...
		script: [
			...
			'/public/components/bootstrap/js/popper.js',
			'/public/components/bootstrap/js/bootstrap.min.js',
			'/public/components/summernote/summernote.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).summernote({
	...
	markdown: {
		selector: '.markdown',
		styles: [
			'/public/components/markdown/markdown.css',
			'/public/components/button/button.css',
			'/public/components/blockquote/blockquote.css',
			'/public/components/font-awesome/font-awesome.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/markdown/markdown.js',
			'/public/components/markdown/to-markdown.js',
			'/public/components/markdown/bootstrap-markdown.js',
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).markdown({
	...
	nestable: {
		...
		styles: [
			'/public/components/font-awesome/font-awesome.css',
			'/public/components/nestable/nestable.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/nestable/nestable.js'
		],
		init: function ( nodes ) {
			$( nodes ).nestable({
	...
	jstree: {
		...
		styles: [
			'/public/components/font-awesome/font-awesome.css',
			'/public/components/jstree/jstree.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/jstree/jstree.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let params = {
	...
	cropper: {
		...
		styles: [
			'/public/components/font-awesome/font-awesome.css',
			'/public/components/cropper/cropper.css'
		],
		script: '/public/components/cropper/cropper.min.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let
	...
	fileupload: {
		...
		styles: [
			'/public/components/mdi/mdi.css',
			'/public/components/tower-file-input/tower-file-input.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/tower-file-input/tower-file-input.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).fileInput({
	...
	easyzoom: {
		selector: '.easyzoom',
		styles: '/public/components/easyzoom/easyzoom.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/easyzoom/easyzoom.min.js'
		],
		init: function ( nodes ) {
			$( nodes ).easyZoom();
		}
	...
	xzoom: {
		selector: '.xzoom',
		styles: '/public/components/xzoom/xzoom.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/xzoom/xzoom.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	slick: {
		...
		styles: [
			'/public/components/slick/slick.css',
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/slick/slick.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let
	...
	dropzone: {
		...
		styles: '/public/components/dropzone/dropzone.css',
		script: '/public/components/dropzone/dropzone.min.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				new Dropzone( node, {
					paramName: "file",
	...
	fullscreen: {
		...
		styles: '/public/components/fullscreen/fullscreen.css',
		dependencies: 'currentDevice',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				if ( device.macos() ) {
	...
	animationSample: { // TODO Simple scroll animation
		...
		styles: '/public/components/animate/animate.css',
		init: function ( nodes ) {
			let
				timeoutId = null,
				endCb = null,
	...
	pnotify: {
		selector: 'html',
		styles: [
			'/public/components/alert/alert.css',
			'/public/components/font-awesome/font-awesome.css',
			'/public/components/pnotify/pnotify.css'
		],
		script: [
			'/public/components/pnotify/PNotify.min.js',
			'/public/components/pnotify/PNotifyButtons.min.js'
		],
		init: function () {
	...
	pnotifyButton: {
		...
		script: '/public/components/pnotify/PNotifyButtons.min.js',
	...
	pagination: {
		selector: '.pagination',
		styles: '/public/components/pagination/pagination.css'
	},
	datatables: {
		selector: '.data-table',
		styles: [
			'/public/components/datatables/datatables.css',
			'/public/components/pagination/pagination.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/base/jquery-ui.min.js',
			'/public/components/datatables/datatables.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let opts = {
	...
	driver: {
		...
		styles: '/public/components/driver/driver.css',
		script: '/public/components/driver/driver.min.js',
		init: function ( nodes ) {
	...
	countdown: {
		selector: '.countdown',
		styles: '/public/components/countdown/countdown.css',
		script: [
			'/public/components/base/util.min.js',
			'/public/components/progress-circle/progress-circle.js',
			'/public/components/countdown/countdown.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				aCountdown({
	...
	progressCircle: {
		...
		styles: '/public/components/progress-circle/progress-circle.css',
		script: [
			'/public/components/base/util.min.js',
			'/public/components/progress-circle/counter.js',
			'/public/components/progress-circle/progress-circle.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	particles: {
		...
		styles: '/public/components/particles/particles.css',
		script: [
			'/public/components/base/util.min.js',
			'/public/components/particles/particles.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let
	...
	jsWaves:{
		selector: '.js-waves',
		styles: '/public/components/jsWaves/js-waves.css',
		script: [
			'/public/components/jsWaves/TimelineMax.min.js',
			'/public/components/jsWaves/js-waves.js'
		],
		init: function ( nodes ) {
			waveSettings = {
				speed: 1,
	...
	searchResult: {
		...
		styles: '/public/components/search-result/search-result.css'
	},
	timeline: {
		selector: '.timeline',
		styles: '/public/components/timeline/timeline.css',
		init: function ( nodes ) {
	...
	lightgallery: {
		...
		styles: '/public/components/lightgallery/lightgallery.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/lightgallery/lightgallery.min.js',
			'/public/components/base/util.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	fullcalendar: {
		...
		styles: [
			'/public/components/fullcalendar/fullcalendar.css',
			'/public/components/button/button.css',
			'/public/components/table/table.css',
			'/public/components/alert/alert.css',
			'/public/components/card/card.css',
		...
		script: [
			...
			'/public/components/base/jquery-ui.min.js',
			'/public/components/base/moment.min.js',
			'/public/components/fullcalendar/fullcalendar.min.js',
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	jvectorMap: {
		...
		styles: '/public/components/jvector-map/jvector-map.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/jvector-map/jvector-map.js',
			'/public/components/jvector-map/assets/world-mill.js',
			'/public/components/jvector-map/assets/us-lcc-en.js'
		],
		init: function ( nodes ) {
	...
	flotchart: {
		...
		styles: '/public/components/flotchart/flotchart.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/flotchart/flotchart.js',
			'/public/components/flotchart/flotchart-resize.js',
			'/public/components/flotchart/flotchart-pie.js',
			'/public/components/flotchart/flotchart-tooltip.js'
		],
		init: function ( nodes ) {
			/**
	...
	currentDevice: {
		selector: 'html', 
		script: [
			'/public/components/current-device/current-device.min.js',
		]
	},
	rdNavbar: {
		selector: '.rd-navbar',
		styles: [
			'/public/components/font-awesome/font-awesome.css',
			'/public/components/rd-navbar/rd-navbar.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/rd-navbar/rd-navbar.min.js'
		],
		dependencies: 'currentDevice',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	sidebar: {
		selector: '.sidebar',
		styles: '/public/components/sidebar/sidebar.css'
	},
	mobileSidebar: {
		selector: '.mobile-sidebar',
		styles: '/public/components/mobile-sidebar/mobile-sidebar.css'
	},
	highchartsDouble: {
		selector: '[data-highcharts-double="container"]',
		styles: '/public/components/highcharts/highcharts.css',
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/highcharts/highcharts.js',
			'/public/components/highcharts/highcharts-double.init.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	gmap: {
		selector: '.google-map',
		styles: '/public/components/google-map/google-map.css',
		script: [
			'//maps.google.com/maps/api/js?key=AIzaSyBHij4b1Vyck1QAuGQmmyryBYVutjcuoRA&libraries=geometry,places&v=quarterly',
			'/public/components/google-map/google-map.js'
		],
		init: function ( nodes ) {
			let promises = [];
	...
	topbar: {
		selector: '.topbar',
		styles: '/public/components/topbar/topbar.css'
	},
	multiswitch: {
		selector: '[data-multi-switch]',
		script: '/public/components/multiswitch/multiswitch.js',
		dependencies: [
			'currentDevice',
			'rdNavbar'
		],
	...
	jumbotron: {
		selector: '.jumbotron',
		styles: '/public/components/jumbotron/jumbotron.css'
	},
	iconBox: {
		selector: '.icon-box',
		styles: '/public/components/icon-box/icon-box.css'
	},
	dockModal: {
		selector: '[data-dockmodal-button]',
		styles: [
			'/public/components/font-awesome/font-awesome.css',
			'/public/components/dockmodal/dockmodal.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/dockmodal/dockmodal.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				node.addEventListener( 'click', function() {
	...
	widgetCounter: {
		...
		styles: '/public/components/widget-counter/widget-counter.css'
	},
	scroller: {
		selector: '.scroller',
		styles: '/public/components/scroller/scroller.css'
	},
	user: {
		selector: '.user',
		styles: '/public/components/user/user.css'
	},
	jquerySortable: {
		selector: '.sortable',
		styles: [
			'/public/components/font-awesome/font-awesome.css',
			'/public/components/jquery-sortable/jquery-sortable.css'
		],
		script: [
			'/public/components/base/jquery-3.4.1.min.js',
			'/public/components/base/jquery-ui.min.js'
	...
	stateface: {
		selector: '.stateface',
		styles: '/public/components/stateface/stateface.css'
	},
	footer: {
		selector: '.footer',
		styles: '/public/components/footer/footer.css'
	},
	toTop: {
		selector: '.to-top',
		script: '/public/components/base/jquery-3.4.1.min.js',
